 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|                                     
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |NonUS\|  <>  | Home | End  | F23  |                                     
 * |------+------+------+------+------+------+------+------+------+------+------+------|                                     
 * |   ,  |      |      |      |Lower |             |Raise | Play | Vol- | Vol+ | Next |                                     
 * `-----------------------------------------------------------------------------------'                                     
 */
[_RAISE] = LAYOUT_planck_grid(
    KC_TILD,    KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,  KC_CIRC,  KC_AMPR,        KC_ASTR,              KC_LPRN,            KC_RPRN,          _______,
    KC_DELETE,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_UNDS,        KC_PLUS,              KC_LCBR,            KC_RCBR,          KC_PIPE,
    _______,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_NONUS_HASH,  KC_NONUS_BSLASH,      KC_HOME,            KC_END,           KC_F23,
    KC_COMMA,   _______,  _______,  _______,  _______,  _______,  KC_NO,    _______,        KC_MEDIA_PLAY_PAUSE,  KC_AUDIO_VOL_DOWN,  KC_AUDIO_VOL_UP,  KC_MEDIA_NEXT_TRACK
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______,    _______,  _______,  _______,  _______,  _______,  KC_NO,   _______,        KC_MEDIA_PLAY_PAUSE,  KC_AUDIO_VOL_DOWN,  KC_AUDIO_VOL_UP,  KC_MEDIA_NEXT_TRACK
),
